...
export class RankingsService {
  ...
  async getRankings(userId: string) {
    const { dayList, ...etc } = await this.dailyRanking(userId);
    const { weekList } = await this.weeklyRanking(userId);
    const { monthList } = await this.monthlyRanking(userId);
  ...
  async dailyRanking(userId: string) {
  ...
  async weeklyRanking(userId: string) {
  ...
  async monthlyRanking(userId: string) {
